...
<div class="pc_container">
    ...
    <div class="wrapper">
        <!-- <div class="wrapper"> -->
            ...
            <a id="a_nutri" href="https://www.webmd.com/pets/dogs/dog-nutrition">
                    <div class="card">
...
<div class="ic_head">
	<h2>
		Featuring pets from friends and families
	</h2>
</div>
    ...
    <div class="footer_cols">
        <div id="f_col1">
            <h2>
             ...
             <p>
                We are dedicated to spreading awareness about the importance of responsible dog ownership and the joy that dogs bring to our lives. Join us in our mission to ensure every dog receives the love, care, and respect they deserve. Together, we can make a difference.
            </p> 
            <!--<p id="location">
